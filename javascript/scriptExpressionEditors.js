...
this.patcher.message("script", "sendbox", fname, "presentation_rect", 0, 175, 258, 45);
...
for (var i = 0; i < fnames.length - 1; i++)
{
	...
	this.patcher.message("script", "sendbox", newobj[j].varname, "patching_rect", 656.526316, 32.219298, 258, 240);
	this.patcher.message("script", "sendbox", newobj[j].varname, "presentation_rect", 0, 175, 258, 240);
	newobj[j].hidden = 1;
	this.patcher.getnamed("menu").message("append", fname);
		}
	}
