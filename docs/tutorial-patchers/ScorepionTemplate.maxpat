...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 555.5, 97.0, 46.0, 47.0 ],
					"text" : "←"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 438.5, 132.0, 69.0, 22.0 ],
					"text" : "universal 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 23.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 307.0, 418.0, 57.0, 22.0 ],
					"text" : "zl slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 210.0, 393.0, 212.0, 22.0 ],
					"text" : "route getNumNotes getTimeSignature"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 102.0, 158.0, 218.0, 22.0 ],
					"text" : "route getNumMeasures getNumStaves"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 720.0, 176.0, 46.0, 47.0 ],
					"text" : "→"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 809.0, 42.0, 46.0, 47.0 ],
					"text" : "→"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.0, 59.0, 46.0, 47.0 ],
					"text" : "←"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 768.0, 140.0, 202.0, 116.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 21.0, 76.0, 100.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 780.0, 78.0, 20.0 ],
					"text" : "to MaxScore"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 770.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 692.0, 86.0, 22.0 ],
					"text" : "clearSelection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 264.0, 500.0, 32.5, 22.0 ],
					"text" : "/ 4."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 210.0, 618.0, 32.5, 22.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 276.0, 631.0, 234.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 210.0, 586.0, 55.0, 22.0 ],
					"text" : "uzi"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 735.0, 56.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 210.0, 552.0, 85.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 276.0, 605.0, 40.0, 22.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 659.0, 109.0, 22.0 ],
					"text" : "addNote $1 0 0 $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 210.0, 476.0, 73.0, 22.0 ],
					"text" : "unpack i i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 210.0, 500.0, 36.5, 22.0 ],
					"text" : "+"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 210.0, 528.0, 36.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 129.0, 341.0, 368.0, 22.0 ],
					"text" : "getNumNotes $1 $2 0, getNumNotes $1 $2 1, getTimeSignature $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 129.0, 367.0, 100.0, 22.0 ],
					"text" : "grab 2 toScore"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 129.0, 314.0, 56.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 210.0, 451.0, 63.0, 22.0 ],
					"text" : "zl group 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 187.0, 218.0, 61.0, 22.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 129.0, 291.0, 59.0, 22.0 ],
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 129.0, 267.0, 59.0, 22.0 ],
					"text" : "divmod 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 102.0, 219.0, 74.0, 22.0 ],
					"text" : "expr $i1*$i2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 102.0, 243.0, 46.0, 22.0 ],
					"text" : "uzi 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 102.0, 187.0, 63.0, 22.0 ],
					"text" : "zl group 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 111.0, 191.0, 22.0 ],
					"text" : "getNumMeasures, getNumStaves"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 21.0, 135.0, 100.0, 22.0 ],
					"text" : "grab 2 toScore"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 111.5, 211.0, 196.5, 211.0 ],
					"order" : 0,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 211.0, 182.5, 111.5, 182.5 ],
					"source" : [ "obj-27", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 238.5, 247.5, 178.5, 247.5 ],
					"source" : [ "obj-29", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 138.5, 338.0, 306.5, 338.0 ],
					"order" : 0,
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 219.5, 556.5, 219.5, 556.5 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 219.5, 773.0, 219.5, 773.0 ],
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 354.5, 446.0, 263.5, 446.0 ],
					"source" : [ "obj-51", 1 ]
				}
