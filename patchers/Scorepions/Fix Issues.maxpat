...
,
		"classnamespace" : "box",
		"openrect" : [ 486.0, 253.0, 249.0, 468.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 95.0, 60.0, 51.0, 22.0 ],
					"text" : "t b clear"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 95.0, 438.769562000000008, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 125.749999999999943, 255.97384599999998, 35.0, 22.0 ],
					"text" : "grab"
				}
...
,
					"patching_rect" : [ 690.941711000000055, 537.483703999999989, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 690.941711000000055, 425.769562000000008, 41.0, 22.0 ],
					"text" : "zl join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 690.941711000000055, 360.682282000000043, 41.0, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 690.941711000000055, 393.349396000000013, 94.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 690.941711000000055, 481.523986999999977, 59.5, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 95.0, 101.0, 196.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.0, 137.0, 225.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.0, 168.0, 221.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.0, 300.0, 121.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 59.0, 338.626465000000053, 121.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 469.0, 17.0, 5.0, 100.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 409.626465000000053, 134.0, 8.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 224.0, 333.988189999999975, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.0, 278.0, 111.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 59.0, 322.626465000000053, 80.0, 20.0 ],
					"text" : "Original Pitch",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.0, 260.626464999999996, 111.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 59.0, 306.626465000000053, 68.500031000000035, 20.0 ],
					"text" : "Hold Time",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 224.0, 255.97384599999998, 18.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 40.750015500000018, 307.626465000000053, 98.249984499999982, 50.0 ],
					"shape" : 2,
					"size" : 3,
					"value" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 224.0, 382.769562000000008, 124.500000000000057, 22.0 ],
					"text" : "gate 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 329.500000000000057, 414.769562000000008, 75.0, 22.0 ],
					"text" : "route PITCH"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.499968999999965, 481.523986999999977, 164.0, 22.0 ],
					"text" : "prepend setNoteDimension 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 501.499969000000021, 343.698792000000026, 75.0, 22.0 ],
					"text" : "loadmess 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 561.5, 397.349396000000013, 111.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 131.0, 306.907532000000003, 46.0, 20.0 ],
					"text" : "Scaler:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.500000000000057, 462.769562000000008, 216.999999999999943, 22.0 ],
					"text" : "expr $f1*$f2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 501.499969000000021, 397.349396000000013, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 180.250061000000017, 305.907532000000003, 41.0, 22.0 ],
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 224.500000000000057, 414.769562000000008, 101.0, 22.0 ],
					"text" : "route DURATION"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.749999999999943, 318.893187999999952, 56.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 397.349396000000013, 56.0, 22.0 ],
					"text" : "deferlow"
				}
...
,
					"patching_rect" : [ 125.749999999999943, 290.893188000000009, 57.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 95.0, 130.0, 50.999938999999998, 22.0 ],
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 524.483703999999989, 364.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 476.0, 524.483703999999989, 159.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.500000000000057, 493.944152999999972, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "int", "bang" ],
					"patching_rect" : [ 329.500000000000057, 349.626464999999996, 104.0, 22.0 ],
					"text" : "maxscore.sax"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 125.749999999999943, 349.626464999999996, 89.0, 22.0 ],
					"text" : "grab 2 toScore"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.0, 88.0, 279.0, 210.0 ],
					"presentation" : 1,
					"presentation_linecount" : 14,
					"presentation_rect" : [ -0.124984499999982, 71.0, 255.0, 225.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 132.0, 666.959716796875, 78.0, 20.0 ],
					"text" : "to MaxScore"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 95.0, 661.959716796875, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 17.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 96.5, 373.0, 51.0, 20.0 ],
					"text" : "Fix...",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 339.000000000000057, 442.0, 453.999968999999965, 442.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 233.5, 309.626464999999996, 322.5, 309.626464999999996, 322.5, 90.0, 281.5, 90.0 ],
					"order" : 0,
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 233.5, 368.628464000000008, 233.5, 368.628464000000008 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 339.000000000000057, 371.628464000000008, 339.000000000000057, 371.628464000000008 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 136.499938999999983, 162.645141999999993, 485.5, 162.645141999999993 ],
					"source" : [ "obj-44", 2 ]
				}
