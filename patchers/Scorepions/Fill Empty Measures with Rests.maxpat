...
,
		"classnamespace" : "box",
		"openrect" : [ 1128.0, 224.0, 261.0, 481.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 118.5, 94.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
,
					"patching_rect" : [ 478.0, 193.0, 63.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 478.0, 222.0, 69.0, 22.0 ],
					"text" : "universal 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 417.0, 441.156585693359375, 54.0, 52.648208618164062 ],
					"presentation" : 1,
					"presentation_rect" : [ 89.375, 7.0, 60.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 411.0, 257.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 21.75, 207.0, 190.0, 21.0 ],
					"text" : "Fill Measures With Rests From "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 352.0, 257.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 20.75, 190.5, 152.0, 21.0 ],
					"text" : "Fill Measures With Rests"
				}
...
, 			{
				"box" : 				{
					...
					"bgfillcolor_color1" : [ 0.376471, 0.384314, 0.4, 0.03 ],
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 422.0, 192.0, 35.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 206.75, 206.0, 35.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 298.0, 100.0, 22.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 62.0, 353.0, 40.0, 22.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.0, 385.0, 193.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.5, 314.0, 129.0, 22.0 ],
					"text" : "fillMeasuresWithRests"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 284.0, 189.0, 22.0 ],
					"text" : "deleteRestsFromEmptyMeasures"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 118.5, 193.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 27.0, 252.0, 54.0, 22.0 ],
					"text" : "gate 3 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.0, 298.0, 74.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 383.0, 271.0, 69.0, 22.0 ],
					"text" : "opendialog"
				}
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 0.376471, 0.384314, 0.4, 0.02 ],
					"id" : "obj-38",
					"ignoreclick" : 1,
					"maxclass" : "textedit",
					"numinlets" : 1,
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 383.0, 333.0, 185.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.25, 228.0, 225.75, 22.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"wordwrap" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 383.0, 132.0, 259.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 20.75, 175.0, 219.0, 21.0 ],
					"text" : "Delete Rests From Empty Measures"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 118.5, 132.0, 221.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.75, 176.0, 260.0, 50.0 ],
					"shape" : 2,
					"size" : 3,
					"value" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.5, 437.0, 56.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.5, 468.0, 385.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 347.0, 397.0, 159.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 383.0, 10.0, 202.0, 116.0 ],
					"presentation" : 1,
					"presentation_linecount" : 6,
					"presentation_rect" : [ 6.375, 69.0, 230.0, 100.0 ],
					"text" : "This Scorepion searches for empty measures and fills them with rests. This process will be applied the entire score and doesn't require notes or measures to be selected beforehand."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 62.0, 6.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 80.75, 301.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 580.0, 78.0, 20.0 ],
					"text" : "to MaxScore"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 172.0, 504.0, 56.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 233.0, 6.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 552.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 356.5, 532.5, 181.5, 532.5 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 21.0, 498.0, 181.5, 498.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-45", 0 ],
					"midpoints" : [ 36.5, 421.0, 181.5, 421.0 ],
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-45", 0 ],
					"midpoints" : [ 54.0, 421.5, 181.5, 421.5 ],
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-45", 0 ],
					"midpoints" : [ 71.5, 421.5, 181.5, 421.5 ],
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 71.5, 43.0, 356.5, 43.0 ],
					"order" : 0,
					"source" : [ "obj-9", 0 ]
				}
