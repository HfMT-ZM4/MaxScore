...
,
		"classnamespace" : "box",
		"openrect" : [ 1129.0, 203.0, 255.0, 627.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 287.0, 164.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 78.0, 245.0, 100.0, 20.0 ],
					"text" : "Copy Notes (c)",
					"textcolor" : [ 0.964705882352941, 0.964705882352941, 0.964705882352941, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 220.0, 119.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 588.0, 111.0, 192.0, 65.0 ],
					"presentation" : 1,
					"presentation_linecount" : 4,
					"presentation_rect" : [ 6.0, 132.0, 240.0, 65.0 ],
					"text" : "This Scorepion creates a chord out of selected notes. \nSelect a destination before applying the transform.",
					"textcolor" : [ 0.964705882352941, 0.964705882352941, 0.964705882352941, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 160.0, 10.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 158.0, 165.0, 407.0, 20.0 ],
					"text" : "execUnaryCopyBufferTransform com.punosmusic.jmsl.plugins.MelodyToChordTransform"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 441.0, 221.0, 133.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 78.0, 312.0, 100.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 194.5, 213.0, 450.5, 213.0 ],
					"source" : [ "obj-13", 2 ]
				}
