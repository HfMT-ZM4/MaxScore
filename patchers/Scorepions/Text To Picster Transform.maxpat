...
,
		"classnamespace" : "box",
		"openrect" : [ 486.0, 253.0, 249.0, 342.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 53.875015500000018, 234.514026907608013, 84.0, 20.0 ],
					"text" : "decodeURI"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 53.875015500000018, 215.514026907608013, 157.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 246.0, 330.97384599999998, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 35.626214563846588, 218.514026907608013, 168.485434830188751, 34.0 ],
					"shape" : 2,
					"size" : 2,
					"value" : 0
				}
...
,
					"patching_rect" : [ 279.0, 483.852904999999907, 79.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 246.0, 442.951707638587948, 52.0, 22.0 ],
					"text" : "gate 2 1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 107.5, 157.683380000000113, 29.5, 22.0 ],
									"text" : "!= 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "bang" ],
									"patching_rect" : [ 76.5, 128.683380000000113, 81.0, 22.0 ],
									"text" : "sadam.empty"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "bang" ],
					"patching_rect" : [ 246.0, 609.766053000000056, 81.0, 22.0 ],
					"text" : "sadam.empty"
				}
...
,
					"patching_rect" : [ 588.0, 31.0, 63.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 588.0, 60.0, 69.0, 22.0 ],
					"text" : "universal 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 16.0, 11.0, 62.0, 63.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 9.0, 60.0, 60.0 ]
				}
...
, 							{
								"box" : 								{
									"bgcolor" : [ 1.0, 0.698039, 0.698039, 1.0 ],
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 163.5, 359.0, 69.0, 20.0 ],
									"text" : "selectInterval",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 348.0, 385.5, 267.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "int", "bang" ],
					"patching_rect" : [ 279.0, 410.126464999999996, 104.0, 22.0 ],
					"text" : "maxscore.sax"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 125.749999999999943, 379.626464999999996, 172.250000000000057, 22.0 ],
					"text" : "grab 2 toScore"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.0, 88.0, 282.0, 100.0 ],
					"presentation" : 1,
					"presentation_linecount" : 8,
					"presentation_rect" : [ 12.875015500000018, 75.0, 225.0, 132.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 281.0, 51.0, 20.0 ],
					"text" : "Fix...",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-46", 1 ],
					"midpoints" : [ 255.5, 290.368300999999974, 173.249999999999943, 290.368300999999974 ],
					"order" : 1,
					"source" : [ "obj-104", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 255.5, 430.0, 120.499968999999993, 430.0 ],
					"order" : 1,
					"source" : [ "obj-106", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 135.249999999999943, 372.0, 348.5, 372.0 ],
					"order" : 0,
					"source" : [ "obj-59", 0 ]
				}
