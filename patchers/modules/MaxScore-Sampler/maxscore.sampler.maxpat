...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 986.0, 15.0, 83.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 986.0, 44.0, 77.875, 86.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1076.0, 33.0, 5.0, 100.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 281.0, 14.0, 166.0, 38.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 373.0, -1.0, 309.25, 22.0 ],
					"text" : "Chordsnest-Multiphonics.bank.json",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1046.0, 141.0, 18.0, 18.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1016.0, 141.0, 18.0, 18.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 986.0, 141.0, 18.0, 18.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
,
																		...
																		"boxes" : [ 																			{
																				"box" : 																				{
																					...
																					"numoutlets" : 1,
																					"outlettype" : [ "int" ],
																					"patching_rect" : [ 52.705000000000041, 177.0, 29.5, 22.0 ],
																					"text" : "+ 1"
																				}
...
, 																			{
																				"box" : 																				{
																					...
																					"numoutlets" : 1,
																					"outlettype" : [ "" ],
																					"patching_rect" : [ 152.795000000000073, 233.0, 29.5, 22.0 ],
																					"text" : "join"
																				}
...
, 																			{
																				"box" : 																				{
																					...
																					"numoutlets" : 2,
																					"outlettype" : [ "", "" ],
																					"patching_rect" : [ 52.795000000000073, 100.0, 124.0, 22.0 ],
																					"text" : "zl.slice 1"
																				}
...
, 																			{
																				"box" : 																				{
																					...
																					"numoutlets" : 2,
																					"outlettype" : [ "", "" ],
																					"patching_rect" : [ 52.705000000000041, 138.0, 77.0, 22.0 ],
																					"text" : "routepass int"
																				}
...
, 																			{
																				"box" : 																				{
																					...
																					"numoutlets" : 1,
																					"outlettype" : [ "" ],
																					"patching_rect" : [ 52.795000000000073, 40.0, 30.0, 30.0 ]
																				}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 2,
																	"outlettype" : [ "", "" ],
																	"patching_rect" : [ 147.0, 343.0, 94.880720853805542, 22.0 ],
																	"text" : "zl slice 1"
																}
...
, 															{
																"patchline" : 																{
																	"destination" : [ "obj-50", 1 ],
																	"midpoints" : [ 543.5, 376.481653213500977, 141.0, 376.481653213500977 ],
																	"source" : [ "obj-49", 0 ]
																}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 87.756598240469259, 230.0, 517.214076246335935, 22.0 ],
									"text" : "mc.combine~ 32"
								}
