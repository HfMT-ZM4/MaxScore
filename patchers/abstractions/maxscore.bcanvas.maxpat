...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 131.0, 131.0, 67.0, 22.0 ],
									"text" : "mousefilter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 37.0, 273.0, 32.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 162.0, 233.0, 22.0, 22.0 ],
									"text" : "t 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 131.0, 233.0, 22.0, 22.0 ],
									"text" : "t 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 131.0, 168.0, 70.5, 22.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 131.0, 200.0, 50.0, 22.0 ],
									"text" : "sel hide"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 50.0, 89.0, 181.0, 22.0 ],
									"text" : "routepass clearGraphics bounds"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 37.0, 339.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 192.0, 312.5, 46.5, 312.5 ],
									"source" : [ "obj-2", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-63", 0 ],
									"midpoints" : [ 221.5, 312.5, 46.5, 312.5 ],
									"source" : [ "obj-39", 2 ]
								}
...
,
					"patching_rect" : [ 350.333332999999925, 434.0, 77.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.999999984558031, 318.0, 114.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 289.5, 110.0, 22.0 ],
					"text" : "loadmess #0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 297.666665999999964, 434.0, 19.0, 19.0 ],
					"varname" : "savedialog"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 400.0, 377.5, 144.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
,
					"patching_rect" : [ 416.333332999999925, 506.0, 78.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 500.499999984558031, 682.362392425537109, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 460.0, 800.0 ],
					"readonly" : 1,
					"rounded" : 0.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.333332999999982, 377.5, 35.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "int" ],
					"patching_rect" : [ 78.166665999999964, 497.0, 40.0, 22.0 ],
					"text" : "t 0 l 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 565.333333333333371, 682.362392425537109, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 273.999999333333278, 434.0, 19.0, 19.0 ],
					"varname" : "opendialog"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 350.333332999999925, 682.362392425537109, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.666665999999964, 682.362392425537109, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 639.0, 483.0 ],
					"varname" : "pane"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 39.5, 666.181196212768555, 196.166665999999964, 666.181196212768555 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-33", 0 ],
					"midpoints" : [ 39.999999333333292, 413.75, 509.999999984558031, 413.75 ],
					"source" : [ "obj-19", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 26.333332666666628, 423.75, 359.833332999999925, 423.75 ],
					"source" : [ "obj-19", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 108.666665999999964, 666.0, 196.166665999999964, 666.0 ],
					"source" : [ "obj-2", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 98.166665999999964, 666.681196212768555, 196.166665999999964, 666.681196212768555 ],
					"source" : [ "obj-29", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 299.833332999999982, 460.0, 214.666665999999964, 460.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 129.999999333333307, 583.25, 574.833333333333371, 583.25 ],
					"source" : [ "obj-34", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 158.452380285714241, 396.0, 259.833332666666649, 396.0 ],
					"order" : 0,
					"source" : [ "obj-51", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 237.666665999999964, 667.0, 196.166665999999964, 667.0 ],
					"source" : [ "obj-9", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 12.666665999999964, 666.181196212768555, 196.166665999999964, 666.181196212768555 ],
					"source" : [ "obj-9", 0 ]
				}
