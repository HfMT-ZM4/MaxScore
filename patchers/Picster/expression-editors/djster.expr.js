...
function bang() {
  ...
  //draw box
  var border = JSON.parse('{"new":"rect","x":0,"y":0,"width":120,"height":90,"style":{"stroke":"'+colorPalette.border[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  border.id = groupId+"_border";
  outputPicster["picster-element"][0]["val"]["child"].push(border);
  var bgfill = JSON.parse('{"new":"rect","x":0,"y":0,"width":120,"height":90,"style":{"fill":"'+colorPalette.background+'","fill-opacity":0.8},"transform":"matrix(1,0,0,1,0,0)"}');
  bgfill.id = groupId+"_bgfill";
  outputPicster["picster-element"][0]["val"]["child"].push(bgfill);

  //main stem
  var stem = JSON.parse('{"new":"line","x1":63,"y1":17,"x2":63,"y2":55,"style":{"stroke":"'+colorPalette.meter.dark[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("meter" in djsterAttributes) {
    ...
    for (var j = 0; j < l; j++) {
      ...
      var vert = JSON.parse('{"new":"line","x1":'+xr+',"y1":17,"x2":'+xr+',"y2":'+yd+',"style":{"stroke":"'+colorPalette.meter.dark[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
      vert.id = groupId+"_meter_vert_"+j;
      outputPicster["picster-element"][0]["val"]["child"].push(vert);
      var hor = JSON.parse('{"new":"line","x1":'+xl+',"y1":'+yu+',"x2":116,"y2":'+yu+',"style":{"stroke":"'+colorPalette.meter.dark[onoff]+'","stroke-width":2,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
      hor.id = groupId+"_meter_hor_"+j;
      outputPicster["picster-element"][0]["val"]["child"].push(hor);
      var text = JSON.parse('{"new":"text","y":'+(yd+2)+',"font-family":"Aloisen New","text-anchor":"middle","font-size":20,"style":{"fill":"'+colorPalette.meter.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
      text.x = (xl+xr)/2;
  ...
  if ("event_length" in djsterAttributes && "pulse_length" in djsterAttributes) {
    if (djsterAttributes.event_length > djsterAttributes.pulse_length) {
      var thickh = JSON.parse('{"new":"line","x1":60,"y1":56,"x2":115,"y2":56,"style":{"stroke":"'+colorPalette.event.dark[onoff]+'","stroke-width":3,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
      thickh.id = groupId+"_event_thickh";
      outputPicster["picster-element"][0]["val"]["child"].push(thickh);
      var shortv = JSON.parse('{"new":"line","x1":115,"y1":54,"x2":115,"y2":58,"style":{"stroke":"'+colorPalette.event.dark[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
      shortv.id = groupId+"_event_shortv";
      outputPicster["picster-element"][0]["val"]["child"].push(shortv);
      var longv = JSON.parse('{"new":"line","x1":90,"y1":52,"x2":90,"y2":60,"style":{"stroke":"'+colorPalette.event.dark[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
      longv.id = groupId+"_event_longv";
      outputPicster["picster-element"][0]["val"]["child"].push(longv);
    }
    else {
      var thickh = JSON.parse('{"new":"line","x1":60,"y1":56,"x2":90,"y2":56,"style":{"stroke":"'+colorPalette.event.dark[onoff]+'","stroke-width":3,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
      thickh.id = groupId+"_event_thickh";
      outputPicster["picster-element"][0]["val"]["child"].push(thickh);
      var thinh = JSON.parse('{"new":"line","x1":60,"y1":56,"x2":115,"y2":56,"style":{"stroke":"'+colorPalette.event.dark[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
      thinh.id = groupId+"_event_thinh";
      outputPicster["picster-element"][0]["val"]["child"].push(thinh);
      var shortv = JSON.parse('{"new":"line","x1":90,"y1":54,"x2":90,"y2":58,"style":{"stroke":"'+colorPalette.event.dark[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
      shortv.id = groupId+"_event_shortv";
      outputPicster["picster-element"][0]["val"]["child"].push(shortv);
      var longv = JSON.parse('{"new":"line","x1":115,"y1":52,"x2":115,"y2":60,"style":{"stroke":"'+colorPalette.event.dark[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
      longv.id = groupId+"_event_longv";
      outputPicster["picster-element"][0]["val"]["child"].push(longv);
    }
    var smaller = JSON.parse('{"new":"text","x":89,"y":54,"text-anchor":"end","font-family":"Arial","font-size":8,"style":{"fill":"'+colorPalette.event.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    ...
    var larger = JSON.parse('{"new":"text","x":114,"y":54,"text-anchor":"end","font-family":"Arial","font-size":8,"style":{"fill":"'+colorPalette.event.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  //main notehead
  var notehead = JSON.parse('{"new":"text","x":55,"y":55,"font-family":"Aloisen New","child":"","font-size":28,"style":{"fill":"'+colorPalette.pitch.mid[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("chordal_weight" in djsterAttributes && djsterAttributes.chordal_weight > 1) {
    for (var j = 1; j < djsterAttributes.chordal_weight; j++) {
      var y = 54 - j*5;
      var chordal_weight = JSON.parse('{"new":"text","x":57,"y":'+y+',"font-family":"Aloisen New","child":"","font-size":18,"style":{"fill":"'+colorPalette.pitch.mid[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("silent_downbeat" in djsterAttributes && djsterAttributes.silent_downbeat == 1) {
    var silent_downbeat = JSON.parse('{"new":"text","x":55,"y":21,"child":"","font-family":"Aloisen New","font-size":25,"style":{"fill":"'+colorPalette.meter.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    silent_downbeat.id = groupId+"_silent_downbeat";
    outputPicster["picster-element"][0]["val"]["child"].push(silent_downbeat);
  }

  //pitch bar
  var pitch_vertical = JSON.parse('{"new":"line","x1":23,"y1":18,"x2":23,"y2":70,"style":{"stroke":"'+colorPalette.pitch.dark[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  pitch_vertical.id = groupId+"_pitch_vertical";
  outputPicster["picster-element"][0]["val"]["child"].push(pitch_vertical);
  var pitch_top = JSON.parse('{"new":"line","x1":18,"y1":18,"x2":28,"y2":18,"style":{"stroke":"'+colorPalette.pitch.dark[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  pitch_top.id = groupId+"_pitch_top";
  outputPicster["picster-element"][0]["val"]["child"].push(pitch_top);
  var pitch_bottom = JSON.parse('{"new":"line","x1":18,"y1":71,"x2":28,"y2":71,"style":{"stroke":"'+colorPalette.pitch.dark[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  pitch_bottom.id = groupId+"_pitch_bottom";
  outputPicster["picster-element"][0]["val"]["child"].push(pitch_bottom);
  var pitch_circle = JSON.parse('{"new":"ellipse","cx":23,"cy":44,"rx":5,"ry":5,"style":{"stroke":"'+colorPalette.pitch.dark[onoff]+'","stroke-width":1,"stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("melody_scope" in djsterAttributes) {
    var melody_scope = JSON.parse('{"new":"text","x":28,"y":42,"font-family":"Arial","font-size":10,"style":{"fill":"'+colorPalette.pitch.mid[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("pitch_range" in djsterAttributes && "pitch_center" in djsterAttributes) {
    var pitch_max = JSON.parse('{"new":"text","x":26,"y":26,"font-family":"Arial","font-size":10,"style":{"fill":"'+colorPalette.pitch.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    ...
    var pitch_min = JSON.parse('{"new":"text","x":26,"y":68,"font-family":"Arial","font-size":10,"style":{"fill":"'+colorPalette.pitch.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("tonic_pitch" in djsterAttributes) {
    var tonic_pitch = JSON.parse('{"new":"text","x":55,"y":55,"text-anchor":"end","font-family":"Arial","font-size":11,"style":{"fill":"'+colorPalette.pitch.mid[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("scale" in djsterAttributes) {
    ...
    var element = JSON.parse('{"new":"text","x":5,"y":11,"font-family":"Arial","font-size":10,"style":{"fill":"'+colorPalette.pitch.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("dynamics" in djsterAttributes) {
    ...
    var fillbar = JSON.parse('{"new":"rect","x":5,"y":75,"width":'+fillbarlength+',"height":10,"style":{"fill":"'+colorPalette.dynamics.light[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    fillbar.id = groupId+"_dynamics_fillbar";
    outputPicster["picster-element"][0]["val"]["child"].push(fillbar);
    var border = JSON.parse('{"new":"rect","x":5,"y":75,"width":53,"height":10,"style":{"stroke":"'+colorPalette.dynamics.dark[onoff]+'","stroke-width":1, "stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    border.id = groupId+"_dynamics_border";
    outputPicster["picster-element"][0]["val"]["child"].push(border);

    var text = JSON.parse('{"new":"text","x":7,"y":83,"child":"D","font-family":"Arial","font-size":8,"style":{"fill":"'+colorPalette.dynamics.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("attenuation" in djsterAttributes) {
    ...
    var fillbar = JSON.parse('{"new":"rect","x":62,"y":75,"width":'+fillbarlength+',"height":10,"style":{"fill":"'+colorPalette.dynamics.light[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    fillbar.id = groupId+"_attenuation_fillbar";
    outputPicster["picster-element"][0]["val"]["child"].push(fillbar);

    var border = JSON.parse('{"new":"rect","x":63,"y":75,"width":53,"height":10,"style":{"stroke":"'+colorPalette.dynamics.dark[onoff]+'","stroke-width":1, "stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    border.id = groupId+"_attenuation_border";
    outputPicster["picster-element"][0]["val"]["child"].push(border);

    var text = JSON.parse('{"new":"text","x":64,"y":83,"child":"A","font-family":"Arial","font-size":8,"style":{"fill":"'+colorPalette.dynamics.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("eventfulness" in djsterAttributes) {
    ...
    var fillbar = JSON.parse('{"new":"rect","x":63,"y":61,"width":'+fillbarlength+',"height":10,"style":{"fill":"'+colorPalette.event.light[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    fillbar.id = groupId+"_eventfulness_fillbar";
    outputPicster["picster-element"][0]["val"]["child"].push(fillbar);

    var border = JSON.parse('{"new":"rect","x":63,"y":61,"width":53,"height":10,"style":{"stroke":"'+colorPalette.event.dark[onoff]+'","stroke-width":1, "stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    border.id = groupId+"_eventfulness_border";
    outputPicster["picster-element"][0]["val"]["child"].push(border);

    var text = JSON.parse('{"new":"text","x":64,"y":69,"child":"E","font-family":"Arial","font-size":8,"style":{"fill":"'+colorPalette.event.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("harmoniclarity" in djsterAttributes) {
    ...
    var fillbar = JSON.parse('{"new":"rect","x":5,"y":'+fillbarystart+',"width":10,"height":'+fillbarlength+',"style":{"fill":"'+colorPalette.pitch.light[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    fillbar.id = groupId+"_harmoniclarity_fillbar";
    outputPicster["picster-element"][0]["val"]["child"].push(fillbar);

    var border = JSON.parse('{"new":"rect","x":5,"y":18,"width":10,"height":53,"style":{"stroke":"'+colorPalette.pitch.dark[onoff]+'","stroke-width":1, "stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    border.id = groupId+"_harmoniclarity_border";
    outputPicster["picster-element"][0]["val"]["child"].push(border);

    var text = JSON.parse('{"new":"text","x":7,"y":67,"child":"H","font-family":"Arial","font-size":8,"style":{"fill":"'+colorPalette.pitch.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
  ...
  if ("metriclarity" in djsterAttributes) {
    ...
    var fillbar = JSON.parse('{"new":"rect","x":63,"y":3,"width":'+fillbarlength+',"height":10,"style":{"fill":"'+colorPalette.meter.light[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    fillbar.id = groupId+"_metriclarity_fillbar";
    outputPicster["picster-element"][0]["val"]["child"].push(fillbar);

    var border = JSON.parse('{"new":"rect","x":63,"y":3,"width":53,"height":10,"style":{"stroke":"'+colorPalette.meter.dark[onoff]+'","stroke-width":1, "stroke-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
    border.id = groupId+"_metriclarity_border";
    outputPicster["picster-element"][0]["val"]["child"].push(border);

    var text = JSON.parse('{"new":"text","x":64,"y":11,"child":"M","font-family":"Arial","font-size":8,"style":{"fill":"'+colorPalette.meter.dark[onoff]+'","fill-opacity":1},"transform":"matrix(1,0,0,1,0,0)"}');
