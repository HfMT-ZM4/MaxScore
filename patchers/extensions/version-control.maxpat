...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 143.0, 261.0, 29.5, 22.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 183.0, 214.0, 53.0, 22.0 ],
					"text" : "list.nth 3"
				}
...
, 			{
				"box" : 				{
					...
					"readonly" : 1,
					"text" : "Your version is: 0 A newer version is available: 2.5.8 Would you like to download it?"
				}
