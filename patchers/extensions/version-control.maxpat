...
,
		"classnamespace" : "box",
		"openrect" : [ 444.0, 263.0, 454.0, 173.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 284.0, 256.0, 86.0, 22.0 ],
					"text" : "route notfound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 183.0, 612.0, 97.5, 22.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 182.0, 432.0, 40.0, 22.0 ],
					"text" : "t l l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.0, 576.0, 38.5, 22.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 322.0, 428.0, 50.5, 22.0 ],
					"text" : "t l l l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 203.0, 576.0, 38.0, 22.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 253.0, 354.0, 61.0, 22.0 ],
					"text" : "set 2.0.13"
				}
...
,
					"patching_rect" : [ 412.0, 489.0, 70.0, 22.0 ],
					"saved_object_attributes" : 					{
						"editing_bgcolor" : [ 0.309803921568627, 0.309803921568627, 0.309803921568627, 1.0 ],
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 143.0, 295.0, 37.0, 22.0 ],
					"text" : "sel 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 143.0, 261.0, 45.0, 22.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 20.0, 131.0, 141.5, 22.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 169.0, 228.0, 53.0, 22.0 ],
					"text" : "list.nth 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 229.0, 71.0, 22.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 195.0, 76.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "getversion",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 99.0, 281.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "dictionary", "" ],
					"patching_rect" : [ 20.0, 162.0, 109.0, 22.0 ],
					"text" : "maxurl"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 534.0, 159.0, 22.0 ],
...
,
					"patching_rect" : [ 182.0, 483.0, 180.0, 22.0 ],
					"saved_object_attributes" : 					{
						"editing_bgcolor" : [ 0.56078431372549, 0.56078431372549, 0.56078431372549, 1.0 ],
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 143.0, 168.0, 60.0, 22.0 ],
					"text" : "del 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.0, 653.0, 518.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "float" ],
					"patching_rect" : [ 812.0, 138.0, 46.0, 22.0 ],
					"text" : "t l l 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 624.0, 168.0, 50.0, 22.0 ],
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 463.0, 525.0, 379.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 412.0, 576.0, 194.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 121.5, 130.0, 210.0, 13.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 68.0, 12.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 624.0, 138.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 231.5, 89.0, 100.0, 20.0 ],
					"text" : "Cancel",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 463.0, 450.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 121.5, 89.0, 100.0, 20.0 ],
					"text" : "Download",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textovercolor" : [ 0.1, 0.1, 0.1, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 548.0, 138.0, 37.0, 22.0 ],
					"text" : "front"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 548.0, 201.0, 74.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 322.0, 399.0, 61.0, 22.0 ],
					"text" : "route set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.0, 228.0, 284.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.0, 69.0, 811.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 322.0, 354.0, 46.0, 22.0 ],
					"text" : "text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 322.0, 312.0, 90.0, 22.0 ],
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 143.0, 761.0, 588.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 62.0, 30.0, 327.0, 48.0 ],
					"readonly" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 685.0, 235.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 183.0, 717.0, 518.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 183.0, 534.0, 57.0, 22.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 183.0, 399.0, 52.0, 22.0 ],
					"text" : "zl nth 2"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 342.0, 519.0, 248.5, 519.0 ],
					"source" : [ "obj-117", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 331.5, 563.25, 231.5, 563.25 ],
					"source" : [ "obj-117", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 363.0, 568.25, 290.0, 568.25 ],
					"source" : [ "obj-117", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 270.5, 606.0, 271.0, 606.0 ],
					"source" : [ "obj-118", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 202.0, 466.5, 421.5, 466.5 ],
					"source" : [ "obj-119", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 212.5, 480.0, 270.5, 480.0 ],
					"source" : [ "obj-119", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 835.0, 754.5, 152.5, 754.5 ],
					"source" : [ "obj-56", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 848.5, 560.5, 421.5, 560.5 ],
					"source" : [ "obj-56", 2 ]
				}
