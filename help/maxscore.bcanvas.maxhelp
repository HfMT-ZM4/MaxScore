...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 527.0, 582.5, 650.0, 172.0 ],
									"rendermode" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "/stdout : \"received socket close /1 bkUoB/U+GW91Vpbf3B/MfQ==\""
								}
