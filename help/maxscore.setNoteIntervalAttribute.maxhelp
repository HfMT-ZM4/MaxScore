...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 695.0, 131.0, 165.0, 20.0 ],
					"text" : "Corresponding message"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.0, 131.0, 165.0, 20.0 ],
					"text" : "Attribute"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.5, 320.0, 167.0, 22.0 ],
					"text" : "noteStemVisibilityTransform 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 107.5, 246.0, 29.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.0, 157.0, 219.0, 516.0 ],
					"text" : "\"NOTEDUR\",  \n\"TUPLET\",  \n\"DOTS\",  \n\"ACCINFO\",  \n\"DURATION\",  \n\"PITCH\",  \"\nVELOCITY\", \n\"HOLD\",  \n\"BEAMEDOUT\",  \n\"GLISSOUT\", \n\"TIEDOUT\",  \n\"ACCPREF\",  \n\"ACCVISPOLICY\",  \"ALTENHARMONIC\",  \n\"DYN\",  \n\"SLUROUT\",  \n\"ISGRACENOTE\",  \"LEDGERLINESVISIBLE\", \n\"WEDGE\",  \n\"OTTAVA\",  \n\"MARK\",  \n\"NOTEHEAD\",  \n\"NOTEHEADSCALE\", \n\"VISIBLE\",  \n\"NOTEHEADVISIBLE\",  \"STEMVISIBLE\",  \n\"OVERRIDELEVEL\", \"ISOVERRIDELEVEL\", \"STEMINFOOVERRIDE\", \"STEMINFO\", \n\"TEXT\", \n\"TEXTOFFSETX\", \n\"TEXTOFFSETY\", \n\"LAYOUTSHIFTX\",\n\"NOTEHEADRED\",\n\"NOTEHEADGREEN\", \"NOTEHEADBLUE\",\n\"GRACENOTESEPARATIONSCALER\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.0, 290.0, 201.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "newScore" ],
					"patching_rect" : [ 107.5, 393.0, 125.0, 22.0 ],
					"text" : "MaxScore setattribute"
				}
